...
namespace Herta
{
    public static class BitOperationsHelpers
    {
        ...
        public static int Log10(uint value)
        {
            ...
            return value < PowersOf10[num2] ? num2 - 1 : num2;
        }
        ...
        public static void And(Span<int> destination, Span<int> source, uint count)
        {
            ...
            ref int left = ref MemoryMarshal.GetReference(destination);
            ref int right = ref MemoryMarshal.GetReference(source);
#if NET7_0_OR_GREATER
            uint i = 0;
        ...
        public static void Not(Span<int> destination, uint count)
        {
            ...
            ref int value = ref MemoryMarshal.GetReference(destination);
#if NET7_0_OR_GREATER
            uint i = 0;
            if (Vector256.IsHardwareAccelerated)
            {
