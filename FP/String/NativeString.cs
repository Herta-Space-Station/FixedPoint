...
namespace Herta
{
    ...
    public ref struct NativeString
    {
        /// <summary>
        ///     Buffer
        /// </summary>
        ...
        public bool AppendLine()
        {
            ...
            if (_length + newLine.Length > Capacity)
                return false;
            ref char reference = ref MemoryMarshal.GetReference(_buffer);
        ...
        public bool Replace(ReadOnlySpan<char> oldValue, ReadOnlySpan<char> newValue)
        {
            ...
            ref char local1 = ref MemoryMarshal.GetReference(_buffer);
            if (oldValue.Length == 1)
            {
                ...
                Span<int> buffer1 = stackalloc int[128];
                valueListBuilder = new NativeValueListBuilder<int>(MemoryMarshal.CreateSpan(ref MemoryMarshal.GetReference(buffer1), buffer1.Length));
                char ch = oldValue[0];
                while (true)
                {
                    int num = MemoryMarshal.CreateSpan(ref Unsafe.Add(ref local1, elementOffset1), _length - elementOffset1).IndexOf(ch);
                    if (num >= 0)
                    {
            ...
            {
                Span<int> buffer2 = stackalloc int[128];
                valueListBuilder = new NativeValueListBuilder<int>(MemoryMarshal.CreateSpan(ref MemoryMarshal.GetReference(buffer2), buffer2.Length));
                while (true)
                {
                    int num = MemoryMarshal.CreateSpan(ref Unsafe.Add(ref local1, elementOffset1), _length - elementOffset1).IndexOf(oldValue);
                    if (num >= 0)
                    {
                        valueListBuilder.Append(elementOffset1 + num);
            ...
            if (valueListBuilder.Length == 0)
                return true;
            ReadOnlySpan<int> readOnlySpan = valueListBuilder.AsReadOnlySpan();
            int minimumLength = _length + (newValue.Length - oldValue.Length) * readOnlySpan.Length;
            ...
            char[]? array = null;
            ref char local2 = ref MemoryMarshal.GetReference(minimumLength <= 256 ? stackalloc char[minimumLength] : (Span<char>)(array = ArrayPool<char>.Shared.Rent(minimumLength)));
            int elementOffset2 = 0;
            int elementOffset3 = 0;
            ref char local3 = ref MemoryMarshal.GetReference(newValue);
            for (int index = 0; index < readOnlySpan.Length; ++index)
            {
                int num1 = readOnlySpan[index];
                int num2 = num1 - elementOffset2;
                if (num2 != 0)
                {
        ...
        public void Remove(char value)
        {
            ...
            {
                char ch = Unsafe.Add(ref reference, index);
                if (ch != value)
        ...
        public void Replace(char oldValue, char newValue)
        {
            ...
            for (int index = 0; index < _length; ++index)
            {
                ref char value = ref Unsafe.Add(ref reference, index);
                if (value == oldValue)
                    value = newValue;
            }
#endif
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public NativeString Substring(int start) => new NativeString(Text.Slice(start));
        ...
        /// <param name="length">Length</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public NativeString Substring(int start, int length) => new NativeString(Text.Slice(start, length));
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public NativeSplit<char> Split(in char separator) => new NativeSplit<char>(Text, separator);

        /// <summary>
        ///     Split
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public NativeSplit<char> Split(ReadOnlySpan<char> separator) => new NativeSplit<char>(Text, separator);

        /// <summary>
        ///     Split
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public NativeSplitAny<char> SplitAny(ReadOnlySpan<char> separator) => new NativeSplitAny<char>(Text, separator);

        /// <summary>
        ///     Split
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public NativeSplitRange<char> SplitRange(in char separator) => new NativeSplitRange<char>(Text, separator);

        /// <summary>
        ///     Split
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public NativeSplitRange<char> SplitRange(ReadOnlySpan<char> separator) => new NativeSplitRange<char>(Text, separator);

        /// <summary>
        ///     Split
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public NativeSplitAnyRange<char> SplitAnyRange(ReadOnlySpan<char> separator) => new NativeSplitAnyRange<char>(Text, separator);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NativeString(Span<char> buffer) => new NativeString(buffer);
        ...
        /// <returns>HashCode</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int GetHashCode(ReadOnlySpan<char> buffer) => XxHash.Hash32(buffer);

        /// <summary>
        ///     Create
        /// </summary>
        public static NativeString Create(ReadOnlySpan<char> buffer) => new NativeString(MemoryMarshal.CreateSpan(ref MemoryMarshal.GetReference(buffer), buffer.Length));
        ...
        {
            if (obj.TryFormat(Space, out int charsWritten))
            {
        ...
        {
            if (obj.TryFormat(Space, out int charsWritten, format, provider))
            {
                _length += charsWritten;
                return true;
            }
        ...
        {
            if (obj.TryFormat(Space, out int charsWritten, format))
            {
                _length += charsWritten;
                return true;
            }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool AppendFormattable(nint obj, ReadOnlySpan<char> format = default, IFormatProvider? provider = null) => Unsafe.SizeOf<nint>() == 8 ? AppendFormattable((long)obj, format, provider) : AppendFormattable((int)obj, format, provider);

        /// <summary>
        ///     Append formattable
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool AppendFormattable(nuint obj, ReadOnlySpan<char> format = default, IFormatProvider? provider = null) => Unsafe.SizeOf<nint>() == 8 ? AppendFormattable((ulong)obj, format, provider) : AppendFormattable((uint)obj, format, provider);
